...
import 'detail-member-edit.dart';
import 'profil-admin.dart';
...
class HomeAdmin extends StatelessWidget{
  ...
  HomeAdmin({this.username, this.id, this.membership, this.nama, this.gender, this.email, this.no_telp, this.alamat, this.tgl_join, this.password});
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            new ListTile(
              ...
              onTap: (){
                Navigator.push(context, new MaterialPageRoute(builder: (context) => ProfilAdmin(username:username, id:id, membership:membership, nama:nama, gender:gender, email:email, no_telp:no_telp, alamat:alamat, tgl_join:tgl_join, password:password,)));
              },
            ),
            new ListTile(
              ...
              onTap: (){
                Navigator.push(context, new MaterialPageRoute(builder: (context) => DaftarMember()));
              },
            ),
            Divider(),
            new ListTile(
    ...
    return new ListView.builder(
      ...
      itemBuilder: (context, i){
        return new Container(
          child: new GestureDetector(
            onTap:(){
              Navigator.push(context, new MaterialPageRoute(builder: (context) => DetailMemberEdit(list: list, index: i,)));
            },
            child: new Card(
              child: Padding(
                padding: const EdgeInsets.all(20.0),
