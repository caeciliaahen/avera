import 'package:avera/login-admin.dart';
...
class EditProfilAdmin extends StatefulWidget {
  ...
  EditProfilAdmin({Key key, this.username, this.id, this.membership, this.nama, this.gender, this.email, this.no_telp, this.alamat, this.tgl_join, this.password}) : super(key: key);
  @override
  _EditProfilAdminState createState() => _EditProfilAdminState();
}
...
class _EditProfilAdminState extends State<EditProfilAdmin> {
  ...
  void editData(){
    var url = "http://192.168.100.59/avera/editprofiladmin.php";
    http.post(url, body:{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: new AppBar(
        title: new Text('Edit Profil Admin'),
      ),
      body: Container(
        child: Center(
          child: ListView(
      ...
      child: Column(
        ...
        children: <Widget>[
          TextFormField(
            ...
            obscureText: false,
            decoration: InputDecoration(
              hintText: 'Masukkan Tanggal Join (YYYY-MM-DD)',
