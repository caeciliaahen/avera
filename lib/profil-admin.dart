...
import 'edit-profil-admin.dart';

class ProfilAdmin extends StatelessWidget {
  ProfilAdmin({this.username, this.id, this.membership, this.nama, this.gender, this.email, this.no_telp, this.alamat, this.tgl_join, this.password});
                    ...
                    Padding(
                      ...
                      child: Material(
                        ...
                        child: MaterialButton(
                          ...
                          height: 35.0,
                          onPressed: () {
                            Navigator.push(context, new MaterialPageRoute(builder: (context) => EditProfilAdmin(username:username, id:id, membership:membership, nama:nama, gender:gender, email:email, no_telp:no_telp, alamat:alamat, tgl_join:tgl_join, password:password,)));
                          },
